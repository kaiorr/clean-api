...
describe('SingUp Controller', () => {
  ...
  test('shoul return 400 if password confirmation fails ', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('shoul call AddAccount with correct values ', () => {
  ...
  test('shoul return 500 if AddAccount throws ', () => {
  ...
  test('shoul return 200 if valid data is provided ', () => {
    const { sut } = makeSut()
